...
namespace bullet_3da
{
		...
		Entity(/*scene*/)
	{
		...
		wheel_r1_constraint = new btHingeConstraint(*wheel_rb_r1->get(), *body_rb->get(), btVector3(0.f, 0.f, 0.f), btVector3(-7.f, -3.f, 9.f), btVector3(0.f, 0.f, -1.f), btVector3(0.f, 0.f, 0.f));
		wheel_r1_constraint->enableAngularMotor(true, 0.f, 10.f);
		scene->get_physics_world()->addConstraints(wheel_r1_constraint);

		wheel_r2_constraint = new btHingeConstraint(*wheel_rb_r2->get(), *body_rb->get(), btVector3(0.f, 0.f, 0.f), btVector3(-7.f, -3.f, -9.5f), btVector3(0.f, 0.f, -1.f), btVector3(0.f, 0.f, 0.f));
		wheel_r2_constraint->enableAngularMotor(true, 0.f, 10.f);
		scene->get_physics_world()->addConstraints(wheel_r2_constraint);

		wheel_l1_constraint = new btHingeConstraint(*wheel_rb_l1->get(), *body_rb->get(), btVector3(0.f, 0.f, 0.f), btVector3(7.f, -3.f, 9.f), btVector3(0.f, 0.f, -1.f), btVector3(0.f, 0.f, 0.f));
		wheel_l1_constraint->enableAngularMotor(true, 0.f, 10.f);
		scene->get_physics_world()->addConstraints(wheel_l1_constraint);

		wheel_l2_constraint = new btHingeConstraint(*wheel_rb_l2->get(), *body_rb->get(), btVector3(0.f, 0.f, 0.f), btVector3(7.f, -3.f, -9.5f), btVector3(0.f, 0.f, -1.f), btVector3(0.f, 0.f, 0.f));
